...
def main():
    ...
    fbx_file = "/home/giuliamartinelli/Code/R2ET/visualization/Aj.fbx"
    bvh_file = "/home/giuliamartinelli/Code/R2ET/visualization/gt_quat.bvh"
    ...
    bvh_file = set_rest_pose_bvh(bvh_file, source_arm)
    bvh_name = load_bvh(bvh_file)
    dest_arm = bpy.data.objects[bvh_name]
    source_arm.scale = [0.1, 0.1, 0.1]  # scale the bvh to match the fbx
    ...
    add_rendering_parameters(bpy.context.scene, args, scene[1],"/home/giuliamartinelli/Code/moma/DATRetarget/blender_rendering/prova.py")
