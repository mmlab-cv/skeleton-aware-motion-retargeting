...
class Options:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--save_path', type=str, default='/home/giulia.martinelli-2/Documents/Code/DATRetarget/results/', help='path of output video file')
        ...
        self.parser.add_argument('--frame_end', type=int, default=64, help='the index of the last rendered frame')
